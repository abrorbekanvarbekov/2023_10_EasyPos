        ...
        if (currCartItems.size() != 0) {
            for (CartItems currentCartItem : currCartItems) {
                ...
                if (item != null && currTableNum != afterTableNum) {
                    System.out.println(currentCartItem.getProductSailPrice());
...
//    @RequestMapping("/usr/tables/detail/freeProduct")
//    @ResponseBody
//    public String freeProduct(int productId, int tabId, int floor, String productName, int productSailPrice) {
//        tableService.freeProductUpdate(productId, tabId, floor, productName, productSailPrice);
//        return "";
//    }
//
//    @RequestMapping("/usr/tables/detail/cancelFreeProduct")
//    @ResponseBody
//    public String cancelFreeProduct(int productId, int tabId, int floor, String productName, int productSailPrice) {
//        tableService.cancelFreeProduct(productId, tabId, floor, productName, productSailPrice);
//        return "";
//    }
